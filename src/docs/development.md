...
| `npm run lint`         | Both of the above, what CI runs                      |
...
comment next to the rule. The comments are the documentation of the rules; for
the complete set of active rules, including the inherited ones, run
`npm run inspect`.
